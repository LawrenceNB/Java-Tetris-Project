...
public abstract class Tetrimino implements Animatable
{
  ...
  /*  
    ...
    {
        double a[] = {_block4.getX(),_block3.getX(),_block2.getX(),_block1.getX()} ;
        Arrays.sort(a);
        return (int) a[0];
    ...
    
    {
        double a[] = {_block4.getX(),_block3.getX(),_block2.getX(),_block1.getX()} ;
        Arrays.sort(a);
        return (int) a[3]+TetrisConstants.BLOCK_SIZE;
    ...
    
    {
        ...
        double a[] = {_block4.getY(),_block3.getY(),_block2.getY(),_block1.getY()} ;
        Arrays.sort(a);
        return (int) a[3]+TetrisConstants.BLOCK_SIZE;
